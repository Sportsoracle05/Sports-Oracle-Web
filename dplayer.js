...
var scriptHost = 'play.webvideocore.net';
...
if(!document.getElementById('sticky-module')) {
	...
	stickyModule.src = (document.location.protocol === 'https:' ? 'https:' : 'http:') + '//' + scriptHost + '/js/sticky_player.js';
...
function SVPDynamicPlayer(id, url, width, height, internal_params, vars, params) {
	...
	this.is_ssl = document.location.protocol === 'https:';
